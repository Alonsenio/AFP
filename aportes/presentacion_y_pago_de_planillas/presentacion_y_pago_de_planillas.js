...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .watermark { position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%) rotate(-35deg); font-size: 45px; color: rgba(229, 229, 229, 0.66); font-weight: bold; letter-spacing: 15px; pointer-events: none; z-index: 0; white-space: nowrap; }
